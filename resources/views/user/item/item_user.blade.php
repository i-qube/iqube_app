                    ...
                    <tbody>
                        @foreach ($items as $item)
                            <tr class="md-8">
                                ...
                                @if ($item->item_qty != 0)
                                <td colspan="1">
                                    <button id="button" class="p-4 w-full bg-yellow-500 text-white rounded-full text-center hover:bg-blue-500 my-2" onclick="navigateToItemUser('{{ $item->item_name }}')">
                                        <p>Pinjam</p>
                                    </button>
                                </td> 
                                @else
                                ...
                                @endif
                                <script>
                                    function navigateToItemUser(itemName) {
                                        if (itemName) {
                                            window.location.href = "{{ url('item_borrow') }}?item_name=" + itemName;
                                        }
                                    }
                                </script>
                            </tr>
