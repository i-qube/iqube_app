            ...
            <section class="main">
                ...
                <form method="POST" action="{{ url('item_user') }}">
                        ...
                        <form class="max-w-md">
                            <div class="flex justify-between mb-5 relative">
                                <div class="w-full pr-2 relative">
                                    <label for="name" class="text-black pl-5">Nama Barang</label>
                                ...
                                <div class="w-2/4 pl-2 relative">
                                    <label for="name" class="text-black pl-1">Jumlah</label>
                                    <div class="relative max-w-sm">
                                        <input type="number" id="quantity" name="jumlah"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:-blue-500 focus:border-blue-500 block w-1/2 p-2.5 pl-5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-center"
                                            placeholder="Qty">
                                    </div>
                                </div>
                                <div class="flex justify-between mb-5 relative">
                                    <div class="w-2/4 pr-2 relative">
                                        {{-- <label for="name" class="text-black pl-5">Id Barang</label> --}}
                                        <input type="text" id="selection" name="item_id" readonly
                                            class="bg-white-50 border border-white-300 text-white-900 text-sm rounded-full focus:ring-white-500 focus:border-white-500 block w-1/6 p-2.5 pl-6 dark:bg-white-700 dark:border-white-600 dark:placeholder-white-400 dark:text-white dark:focus:ring-white-500 dark:focus:border-white-500">
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="relative max-w-sm">
                        ...
                        <input datepicker type="text" name="date_borrow"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:-blue-500 focus:border-blue-500 block w-full p-2.5 pl-10 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
